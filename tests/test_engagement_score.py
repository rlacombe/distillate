# Covers: distillate/main.py, distillate/integrations/remarkable/client.py,
#          distillate/integrations/remarkable/renderer.py, distillate/digest.py,
#          distillate/summarizer.py, distillate/zotero_client.py
...
class TestGetPageCount:
    ...
    def test_counts_pages_from_content(self, tmp_path):
        from distillate.integrations.remarkable.renderer import get_page_count
