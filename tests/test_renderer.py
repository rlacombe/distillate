...
class TestMergeCrossPage:
    ...
    def test_merges_across_page_break(self):
        from distillate.integrations.remarkable.renderer import _merge_cross_page
...
class TestCleanHighlightText:
    ...
    def test_strips_citation_markers(self):
        from distillate.integrations.remarkable.renderer import _clean_highlight_text
...
class TestRecoverFromPdf:
    ...
    def test_recovers_missing_spaces(self, tmp_path):
        ...
        import zipfile
        import pymupdf
        from distillate.integrations.remarkable.renderer import _recover_from_pdf
