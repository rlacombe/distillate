# Covers: distillate/cloud_sync.py (_merge_single_document, _merge_single_project, _merge_single_run)
"""Tests for cloud sync merge logic: document, project, and run field-level merging."""
...
class TestMergeProject:
    ...
    def test_pull_merges_runs_into_existing_project(self, cloud_env):
        ...
        runs = state.experiments["proj-1"]["runs"]
        assert len(runs) == 2
